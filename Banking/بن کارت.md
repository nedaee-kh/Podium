...
- [احراز هویت](#احراز-هویت)auto 
- [SSO](#sso)auto    
- [نصب پکیج pod-sso-service](#نصب-پکیج-pod-sso-service)auto    
- [دریافت توکن دسترسی کاربر](#دریافت-توکن-دسترسی-کاربر)auto   
- [بروزرسانی توکن دسترسی کاربر](#بروزرسانی-توکن-دسترسی-کاربر)auto   
- [ابطال توکن](#ابطال-توکن)auto    
- [دریافت اطلاعات توکن](#دریافت-اطلاعات-توکن)auto
- [OTP](#otp)auto    
- [ورود با OTP با سرور](#ورود-با-otp-با-سرور)auto    
- [فراخوانی سرویس Handshake سمت SSO](#فراخوانی-سرویس-handshake-سمت-sso)auto    
- [درخواست دریافت کد OTP](#درخواست-دریافت-کد-otp)auto    
- [تایید کد OTP](#تایید-کد-otp)auto    
- [دریافت توکن از سرور SSO](#دریافت-توکن-از-سرور-sso)autoauto
